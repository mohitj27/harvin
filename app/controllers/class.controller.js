...
const addSubjectToClassByClassNameAndUserId = function (
  newClass,
  user,
  updatedSubject
) {
...
// const createNewClass = function (newClass, user) {
// return new Promise(function (resolve, reject) {
//   Class.createAsync({className: newClass.className, addedBy: user})
//     .then(createdClass => resolve(createdClass))
//     .catch(err => reject(err))
// })
// }

const createOrUpdateNewClass = function (newClass, user) {
  return new Promise(function (resolve, reject) {
    Class.findOneAndUpdateAsync(
      { className: newClass.className, addedBy: user },
      newClass,
      {
        upsert: true,
        new: true,
