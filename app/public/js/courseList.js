...
elem=currElement
    var $toastContent = $('<span>Are you sure you want to Delete this Course?</span>').add($('<button class="btn-flat toast-action" onClick="confirmed()">YES</button>')).add($('<button class="btn-flat toast-action" onClick="dismissed()">No</button>'));
