$(function() {
  ...
  var socket = io('https://45.55.154.27/')
      ...
      reader.onload = (function(theFile) {
        return function(e) {
          ...
          span.innerHTML = ['<img class="thumb" src="', e.target.result,
            '" title="', escape(theFile.name), '"/><div>https://45.55.154.27/blogImage/'+theFile.name+ '</div><div class="progress"><div class="indeterminate"></div></div>'
          ].join('')
